...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ds(e,t,n){return new Na({name:`SphericalGaussianBlur`,defines:{SAMPLES:fs,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},sigma:{value:0},mipInt:{value:0}},vertexShader:As(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Os(){return new Na({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:As(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function ks(){return new Na({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:As(),fragmentShader:`
	...
	`}var js=class extends Xt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Ni(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`;continue}if((u=l.match(i))&&(c.gamma=parseFloat(u[1])),(u=l.match(a))&&(c.exposure=parseFloat(u[1])),(u=l.match(o))&&(c.valid|=2,c.format=u[1]),(u=l.match(s))&&(c.valid|=4,c.height=parseInt(u[1],10),c.width=parseInt(u[2],10)),c.valid&2&&c.valid&4)break}return c.valid&2||t(3,`missing format specifier`),c.valid&4||t(3,`missing image size specifier`),c},i=function(e,n,r){let i=n;if(i<8||i>32767||e[0]!==2||e[1]!==2||e[2]&128)return new Uint8Array(e);i!==(e[2]<<8|e[3])&&t(3,`wrong scanline width`);let a=new Uint8Array(4*n*r);a.length||t(4,`unable to allocate buffer space`);let o=0,s=0,c=4*i,l=new Uint8Array(4),u=new Uint8Array(c),d=r;for(;d>0&&s<e.byteLength;){s+4>e.byteLength&&t(1),l[0]=e[s++],l[1]=e[s++],l[2]=e[s++],l[3]=e[s++],(l[0]!=2||l[1]!=2||(l[2]<<8|l[3])!=i)&&t(3,`bad rgbe scanline format`);let n=0,r;for(;n<c&&s<e.byteLength;){r=e[s++];let i=r>128;if(i&&(r-=128),(r===0||n+r>c)&&t(3,`bad scanline data`),i){let t=e[s++];for(let e=0;e<r;e++)u[n++]=t}else u.set(e.subarray(s,s+r),n),n+=r,s+=r}let f=i;for(let e=0;e<f;e++){let t=0;a[o]=u[e+t],t+=i,a[o+1]=u[e+t],t+=i,a[o+2]=u[e+t],t+=i,a[o+3]=u[e+t],o+=4}d--}return a},a=function(e,t,n,r){let i=2**(e[t+3]-128)/255;n[r+0]=e[t+0]*i,n[r+1]=e[t+1]*i,n[r+2]=e[t+2]*i,n[r+3]=1},o=function(e,t,n,r){let i=2**(e[t+3]-128)/255;n[r+0]=gr.toHalfFloat(Math.min(e[t+0]*i,65504)),n[r+1]=gr.toHalfFloat(Math.min(e[t+1]*i,65504)),n[r+2]=gr.toHalfFloat(Math.min(e[t+2]*i,65504)),n[r+3]=gr.toHalfFloat(1)},s=new Uint8Array(e);s.pos=0;let c=r(s),l=c.width,u=c.height,d=i(s.subarray(s.pos),l,u),p,m,h;switch(this.type){case x:h=d.length/4;let e=new Float32Array(h*4);for(let t=0;t<h;t++)a(d,t*4,e,t*4);p=e,m=x;break;case S:h=d.length/4;let t=new Uint16Array(h*4);for(let e=0;e<h;e++)o(d,e*4,t,e*4);p=t,m=S;break;default:throw Error(`THREE.HDRLoader: Unsupported type: `+this.type)}return{width:l,height:u,data:p,header:c.string,gamma:c.gamma,exposure:c.exposure,type:m,colorSpace:Ue,minFilter:f,magFilter:f,generateMipmaps:!1,flipY:!0}}setDataType(e){return this.type=e,this}},Hu=class extends Vu{constructor(e){console.warn(`RGBELoader has been deprecated. Please use HDRLoader instead.`),super(e)}},Uu=[{id:`5x5`,label:`5×5 cm`,size:{width:5,height:5}},{id:`6x6`,label:`6×6 cm`,size:{width:6,height:6}},{id:`7x5`,label:`7×5 cm`,size:{width:7,height:5}},{id:`7x12`,label:`7×12 cm`,size:{width:7,height:12}},{id:`8x8`,label:`8×8 cm`,size:{width:8,height:8}},{id:`8x15`,label:`8×15 cm`,size:{width:8,height:15}},{id:`10x10`,label:`10×10 cm`,size:{width:10,height:10}},{id:`custom`,label:`Personalizado`,size:null}],Wu=[{id:`branco`,label:`Branco`,hex:`#f7f4ef`},{id:`preto`,label:`Preto`,hex:`#1a1a1a`},{id:`vermelho`,label:`Vermelho`,hex:`#b91c1c`},{id:`azul`,label:`Azul`,hex:`#1e3a8a`},{id:`bege`,label:`Bege`,hex:`#d4c4a8`}],Gu=[{id:`cristal`,label:`Cristal`,hex:`#e8f4fc`},{id:`fumaca`,label:`Fumaça`,hex:`#6b7280`},{id:`azul`,label:`Azul`,hex:`#3b82c4`},{id:`ambar`,label:`Âmbar`,hex:`#c47a3b`}],Ku=[{id:`prata`,label:`Prata escovado`,hex:`#c5c9ce`},{id:`preto`,label:`Preto fosco`,hex:`#1c1c1e`},{id:`branco`,label:`Branco`,hex:`#f2f2f0`},{id:`azul`,label:`Azul petróleo`,hex:`#1e3a5f`},{id:`verde`,label:`Verde musgo`,hex:`#3d4f3a`},{id:`rose`,label:`Rose gold`,hex:`#b76e79`}],qu=[{id:`copo_americano`,name:`Copo americano`,description:`Copo americano ~190 ml (Ø 6,7 × H 9,3 cm), paredes de vidro espessas e frisos Nadir. Arte UV DTF frontal — tipicamente 6×6 ou 7×5 cm.`,icon:`🥃`,material:`glass`,diameterCm:6.7,heightCm:9.3,defaultArtSizeCm:{width:6,height:6},maxArtSizeCm:{width:8,height:7},printCenterYCm:5.2,colorParts:[{id:`glass`,label:`Tom do vidro`,default:`#e8f4fc`}]},{id:`xicara_cafe`,name:`Caneca / café`,description:`Caneca cerâmica ~325 ml com alça. Decal frontal no corpo — padrão 8×8 cm.`,icon:`☕`,material:`porcelain`,diameterCm:8.2,heightCm:9.5,defaultArtSizeCm:{width:8,height:8},maxArtSizeCm:{width:10,height:8},printCenterYCm:5,colorParts:[{id:`body`,label:`Corpo`,default:`#f7f4ef`},{id:`handle`,label:`Alça`,default:`#f7f4ef`},{id:`interior`,label:`Interior`,default:`#ffffff`}]},{id:`xicara_cha`,name:`Xícara de chá`,description:`Xícara menor ~200 ml (Ø 7,2 × H 7,2 cm), alça fina. Arte frontal — padrão 6×6 cm.`,icon:`🍵`,material:`porcelain`,diameterCm:7.2,heightCm:7.2,defaultArtSizeCm:{width:6,height:6},maxArtSizeCm:{width:8,height:6},printCenterYCm:3.8,colorParts:[{id:`body`,label:`Corpo`,default:`#f7f4ef`},{id:`handle`,label:`Alça`,default:`#f7f4ef`},{id:`interior`,label:`Interior`,default:`#ffffff`}]},{id:`xicara_dupla_face`,name:`Xícara dupla face`,description:`Caneca compacta ~6,5 cm (estilo espresso / parede dupla). Ideal para artes pequenas — padrão 5×5 cm. Decal frontal (adesivo UV).`,icon:`🧁`,material:`porcelain`,diameterCm:6.4,heightCm:6.5,defaultArtSizeCm:{width:5,height:5},maxArtSizeCm:{width:7,height:5.5},printCenterYCm:3.4,colorParts:[{id:`body`,label:`Corpo`,default:`#f7f4ef`},{id:`handle`,label:`Alça`,default:`#f7f4ef`},{id:`interior`,label:`Interior`,default:`#ffffff`}]},{id:`prato`,name:`Prato`,description:`Prato de sobremesa/jantar (~Ø 20 cm) com borda, poço e pé. Arte centralizada na face — padrão 10×10 cm.`,icon:`🍽️`,material:`porcelain`,diameterCm:20,heightCm:2.2,defaultArtSizeCm:{width:10,height:10},maxArtSizeCm:{width:14,height:14},printCenterYCm:.85,colorParts:[{id:`plate`,label:`Prato`,default:`#f5f0e8`},{id:`rim`,label:`Borda`,default:`#f5f0e8`}]},{id:`garrafa_termica`,name:`Garrafa térmica`,description:`Copo térmico aço ~500 ml (Ø 7,2 × H 20 cm) com tampa. Arte frontal — padrão 7×12 cm.`,icon:`🧴`,material:`metal`,diameterCm:7.2,heightCm:20,defaultArtSizeCm:{width:7,height:12},maxArtSizeCm:{width:9,height:15},printCenterYCm:10.5,colorParts:[{id:`body`,label:`Corpo`,default:`#c5c9ce`},{id:`lid`,label:`Tampa`,default:`#2a2a2c`},{id:`base`,label:`Base`,default:`#1a1a1a`}]}];function Ju(e){let t=qu.find(t=>t.id===e);if(!t)throw Error(`Produto desconhecido: ${e}`);return t}function Yu(e){let t={};for(let n of Ju(e).colorParts)t[n.id]=n.default;return t}var Xu=null;function Zu(){if(Xu)return Xu;let e=document.createElement(`canvas`);e.width=512,e.height=512;let t=e.getContext(`2d`);t.fillStyle=`#808080`,t.fillRect(0,0,512,512);for(let e=0;e<512;e++){let n=110+Math.floor(Math.random()*40)+(e%3==0?18:0);if(t.fillStyle=`rgb(${n},${n},${n})`,t.fillRect(0,e,512,1),Math.random()>.97){let n=160+Math.floor(Math.random()*50);t.fillStyle=`rgb(${n},${n},${n})`,t.fillRect(0,e,512,1)}}let n=new Pi(e);return n.wrapS=o,n.wrapT=o,n.repeat.set(2,6),n.anisotropy=8,n.needsUpdate=!0,n.userData.shared=!0,Xu=n,n}function Qu(e,t={}){return new Ia({color:new J(e),roughness:t.roughness??.22,metalness:0,clearcoat:t.clearcoat??.72,clearcoatRoughness:.12,sheen:.18,sheenRoughness:.45,sheenColor:new J(`#fff8f0`),reflectivity:.55,map:t.map??null,side:0})}function $u(e,t,n=.32){let r=new J(e),i=.025+t*.58;return new Ia({color:r.clone().lerp(new J(`#ffffff`),.35),roughness:i,metalness:0,transmission:Math.max(.04,.94-t*.75),thickness:n,ior:1.52,transparent:!0,opacity:1,attenuationColor:r,attenuationDistance:1.8+t*2.5,specularIntensity:1,envMapIntensity:1.15,side:2,depthWrite:!1})}function ed(e,t={}){let n=t.painted??!1,r=e.toLowerCase(),i=r===`#c5c9ce`||r===`#b76e79`||r.includes(`c5c9`)||r.includes(`b76e`),a=!n&&i;return new Ia({color:new J(e),roughness:t.roughness??(a?.32:n?.48:.38),metalness:t.metalness??(n?.35:.92),clearcoat:n?.35:.15,clearcoatRoughness:n?.35:.4,roughnessMap:a?Zu():null,anisotropy:a?.65:0,anisotropyRotation:0,envMapIntensity:1.2,side:0})}function td(e,t,n,r=128,i=!0){let a=new X(new ya(t,r),n);return a.castShadow=i,a.receiveShadow=!0,e.add(a),a}function nd(e,t){let n=new On,r=e.glass??`#e8f4fc`,i=.3,a=$u(r,t,i),o=$u(r,Math.min(1,t+.04),i*.85);o.side=1,td(n,[new W(.01,0),new W(2.85,0),new W(3,.12),new W(3.08,.45),new W(3.1,1.15),new W(3.12,1.55),new W(3.38,1.72),new W(3.4,1.95),new W(3.14,2.12),new W(3.38,2.32),new W(3.42,2.55),new W(3.15,2.72),new W(3.4,2.92),new W(3.44,3.15),new W(3.16,3.32),new W(3.42,3.52),new W(3.45,3.75),new W(3.18,3.92),new W(3.22,4.6),new W(3.26,6),new W(3.3,7.8),new W(3.33,8.9),new W(3.36,9.18),new W(3.42,9.28),new W(3.38,9.3),new W(3.2,9.3)],a,160),td(n,[new W(3.2-i*.55,9.28),new W(2.98,9.15),new W(2.9200000000000004,8),new W(2.8200000000000003,5.5),new W(2.75,3.5),new W(2.6500000000000004,1.4),new W(2.52,.55),new W(.01,.42)],o,96,!1);let s=$u(r,Math.min(1,t+.12),.8);s.transmission=Math.max(.02,.55-t*.4),s.depthWrite=!0;let c=new X(new Bi(2.88,2.95,.38,64),s);return c.position.y=.19,c.castShadow=!0,n.add(c),n.userData.printRadius=3.28,n.userData.printCenterY=5.2,n.userData.targetY=4.65,n}function rd(e,t){let n=new On,r=e.body??`#f7f4ef`,i=e.handle??r,a=e.interior??`#ffffff`,o=Qu(r,{roughness:.2,clearcoat:.78}),s=Qu(i,{roughness:.24,clearcoat:.7}),c=Qu(a,{roughness:.38,clearcoat:.35}),l=t.height,u=t.rimR,d=t.baseR,f=t.belly,p=l*.48;td(n,[new W(.01,0),new W(d*.92,0),new W(d,.12),new W(d+.08,.35),new W(d+f*.35,l*.18),new W(d+f,p),new W(u-.05,l*.82),new W(u,l-.18),new W(u+.06,l-.04),new W(u+.02,l),new W(u-t.wall*.35,l)],o,128);let m=t.wall;td(n,[new W(u-m*.4,l-.02),new W(u-m,l-.15),new W(u-m-.05,l*.75),new W(d+f-m,p),new W(d-m*.4,l*.2),new W(d-m*.55,.45),new W(.01,.38)],c,96,!1),t.doubleWallHint&&td(n,[new W(u+.08,l*.12),new W(u+.18,l*.35),new W(u+.14,l*.7),new W(u+.05,l-.2)],Qu(r,{roughness:.28,clearcoat:.65}),64,!1);let h=t.handleThick,g=t.handleOut,_=l*.78,v=l*.28,y=u-.15,b=new ta([new G(y,_,0),new G(y+g*.45,_+h*.15,0),new G(y+g,(_+v)*.55,0),new G(y+g*.85,v+(_-v)*.15,0),new G(y+g*.35,v-h*.05,0),new G(y,v,0)]),x=new X(new Ca(b,80,h,20,!1),s);x.castShadow=!0,n.add(x);for(let e of[0,1]){let t=b.getPoint(e),r=new X(new xa(h*1.05,20,16),s);r.position.copy(t),r.castShadow=!0,n.add(r)}return n.userData.printRadius=t.printRadius,n.userData.printCenterY=t.printCenterY,n.userData.targetY=t.targetY,n}function id(e){return rd(e,{height:9.5,rimR:4.1,baseR:3.45,belly:.35,wall:.32,handleThick:.44,handleOut:2.15,printRadius:4,printCenterY:5,targetY:4.75})}function ad(e){return rd(e,{height:7.2,rimR:3.6,baseR:3.05,belly:.28,wall:.28,handleThick:.32,handleOut:1.75,printRadius:3.5,printCenterY:3.8,targetY:3.6})}function od(e){return rd(e,{height:6.5,rimR:3.2,baseR:2.85,belly:.18,wall:.35,handleThick:.3,handleOut:1.55,printRadius:3.15,printCenterY:3.4,targetY:3.25,doubleWallHint:!0})}function sd(e){let t=new On,n=e.plate??`#f5f0e8`,r=e.rim??n,i=Qu(n,{roughness:.26,clearcoat:.65}),a=Qu(r,{roughness:.22,clearcoat:.75});return td(t,[new W(.01,.62),new W(3.5,.6),new W(6.2,.58),new W(7.4,.7),new W(8.3,1.05),new W(9.1,1.55),new W(9.7,1.9),new W(10,2.05),new W(10.05,2.12),new W(10,2.05),new W(9.95,1.75),new W(9.6,1.25),new W(8.6,.7),new W(7.2,.35),new W(5.5,.18),new W(4.2,.15),new W(3.85,.55),new W(3.7,.55),new W(3.55,.12),new W(.01,.1)],i,160),r.toLowerCase()!==n.toLowerCase()&&td(t,[new W(8.8,1.45),new W(9.5,1.85),new W(9.95,2.08),new W(10.05,2.12),new W(10,1.95),new W(9.4,1.55),new W(8.9,1.35)],a,96),t.userData.printRadius=0,t.userData.printCenterY=.85,t.userData.targetY=1.1,t.userData.isFlat=!0,t}function cd(e){let t=new On,n=e.body??`#c5c9ce`,r=e.lid??`#2a2a2c`,i=e.base??`#1a1a1a`,a=n.toLowerCase(),o=ed(n,{painted:a===`#1c1c1e`||a===`#f2f2f0`||a===`#1e3a5f`||a===`#3d4f3a`||!a.includes(`c5c9`)&&!a.includes(`b76e`)&&a!==`#c5c9ce`&&a!==`#b76e79`}),s=ed(r,{painted:!0,roughness:.42,metalness:.55}),c=new Ia({color:new J(i),roughness:.82,metalness:.05,clearcoat:.1}),l=17.2,u=3.35;td(t,[new W(.01,.35),new W(3.3000000000000003,.35),new W(3.45,.55),new W(3.5,1.2),new W(3.6,l*.45),new W(3.5500000000000003,l*.75),new W(u,17.05),new W(3.3000000000000003,l),new W(3.1,l)],o,128);let d=ed(`#2a2a2e`,{painted:!0,roughness:.55,metalness:.4});td(t,[new W(3.0700000000000003,17.15),new W(3,l*.7),new W(3.2,l*.4),new W(3,1),new W(.01,.85)],d,64,!1);let f=new X(new Sa(3.2,.22,16,64),c);f.rotation.x=Math.PI/2,f.position.y=.22,f.castShadow=!0,t.add(f);let p=new X(new Bi(3.1,3.1500000000000004,.2,48),c);p.position.y=.12,p.castShadow=!0,t.add(p);let m=new X(new Bi(3.43,3.47,1.35,64),s);m.position.y=17.88,m.castShadow=!0,t.add(m);let h=ed(r,{painted:!0,roughness:.5,metalness:.45});for(let e=0;e<4;e++){let n=new X(new Sa(3.45,.045,10,48),h);n.rotation.x=Math.PI/2,n.position.y=17.45+e*.22,t.add(n)}let g=new X(new xa(u*.55,32,16,0,Math.PI*2,0,Math.PI/2),s);g.position.y=18.55,g.castShadow=!0,t.add(g);let _=new X(new Bi(.55,.6,.25,32),ed(`#3a3a3c`,{painted:!0,roughness:.35,metalness:.7}));return _.position.y=18.75,_.castShadow=!0,t.add(_),t.userData.printRadius=3.55,t.userData.printCenterY=10.5,t.userData.targetY=10,t}function ld(e,t,n){switch(e){case`copo_americano`:return nd(t,n);case`xicara_cafe`:return id(t);case`xicara_cha`:return ad(t);case`xicara_dupla_face`:return od(t);case`prato`:return sd(t);case`garrafa_termica`:return cd(t);default:return nd(t,n)}}var $=n(),ud=1024,dd=`./hdr/studio_small_03_1k.hdr`;function fd(e,t){let n=document.createElement(`canvas`);n.width=ud,n.height=ud;let r=n.getContext(`2d`);if(r.clearRect(0,0,ud,ud),!e)return n;let i=ud/2,a=ud/2;r.save(),r.translate(i,a),r.rotate(t.rotationDeg*Math.PI/180),r.scale(t.flipH?-1:1,t.flipV?-1:1);let o=e.naturalWidth/Math.max(e.naturalHeight,1),s,c;return o>=1?(s=ud*.92,c=s/o):(c=ud*.92,s=c*o),r.drawImage(e,-s/2,-c/2,s,c),r.restore(),n}function pd(e){e.traverse(e=>{let t=e;if(!t.isMesh)return;t.geometry?.dispose();let n=Array.isArray(t.material)?t.material:[t.material];for(let e of n){if(!e)continue;let t=e;for(let e of[`map`,`roughnessMap`,`metalnessMap`,`normalMap`,`aoMap`]){let n=t[e];n&&!n.userData?.shared&&n.dispose()}e.dispose()}})}function md(e,t,n,r,i){let a=new On,o=e.userData.printRadius??0,s=(e.userData.printCenterY??5)+r.offsetYCm,c=!!e.userData.isFlat,l=Math.max(.5,n.width),u=Math.max(.5,n.height);if(c||o<.1){let n=(e.userData.printCenterY??.85)+.04,o=r.offsetXCm,s=-r.offsetYCm;if(t){let e=new X(new ba(l,u),new Ia({map:t,transparent:!0,roughness:.4,metalness:0,clearcoat:.25,clearcoatRoughness:.35,depthWrite:!1,polygonOffset:!0,polygonOffsetFactor:-2}));e.rotation.x=-Math.PI/2,e.position.set(o,n,s),e.name=`printArea`,a.add(e)}if(i){let e=new Mi(new Gi(new ba(l,u)),new bi({color:3900150,transparent:!0,opacity:.45}));e.rotation.x=-Math.PI/2,e.position.set(o,n+.01,s),a.add(e)}return a}let d=l/o,f=Math.max(32,Math.ceil(d/Math.PI*64)),p=Math.PI/2-d/2,m=o+.05;if(t){let e=new X(new Bi(m,m,u,f,1,!0,p,d),new Ia({map:t,transparent:!0,roughness:.38,metalness:.02,clearcoat:.2,clearcoatRoughness:.4,depthWrite:!1,side:0,polygonOffset:!0,polygonOffsetFactor:-2}));e.position.y=s,e.rotation.y=-r.offsetXCm/o,e.name=`printArea`,a.add(e)}if(i){let e=new Bi(m+.02,m+.02,u,f,1,!0,p,d),t=new Gi(e);e.dispose();let n=new Mi(t,new bi({color:3900150,transparent:!0,opacity:.4}));n.position.y=s,n.rotation.y=-r.offsetXCm/o,a.add(n)}return a}function hd(e){let t=Ju(e);return e===`prato`?26:e===`garrafa_termica`?28:Math.max(14,t.heightCm*1.7+t.diameterCm*.8)}var gd=(0,r.forwardRef)(function({productId:e,colors:t,backgroundColor:n,artImage:i,artSizeCm:a,transform:o,showGuide:c=!0,frosting:l=.08,className:u},d){let f=(0,r.useRef)(null),p=(0,r.useRef)(null);return(0,r.useImperativeHandle)(d,()=>({capture(e,t){let n=p.current,r=f.current;if(!n||!r)return null;n.renderer.setPixelRatio(1),n.renderer.setSize(e,t,!1),n.camera.aspect=e/t,n.camera.updateProjectionMatrix(),n.controls.update(),n.renderer.render(n.scene,n.camera);let i=n.renderer.domElement.toDataURL(`image/png`),a=r.getBoundingClientRect();return n.renderer.setPixelRatio(Math.min(window.devicePixelRatio,2)),n.renderer.setSize(a.width,a.height,!1),n.camera.aspect=a.width/Math.max(a.height,1),n.camera.updateProjectionMatrix(),i},setViewAngle(t){let n=p.current;if(!n)return;let r=n.productRoot?.userData.targetY??Ju(e).heightCm/2,i=hd(e);n.controls.target.set(0,r,0),t===`frente`?n.camera.position.set(0,r+(e===`prato`?8:1.2),i*.95):n.camera.position.set(i*.55,r+(e===`prato`?i*.45:i*.18),i*.7),n.controls.update()}})),(0,r.useEffect)(()=>{let e=f.current;if(!e)return;let t=new In;t.background=new J(n);let r=new Eo(32,1,.1,250);r.position.set(11,8,14);let i=new hu({antialias:!0,preserveDrawingBuffer:!0,alpha:!1,powerPreference:`high-performance`});i.setPixelRatio(Math.min(window.devicePixelRatio,2)),i.shadowMap.enabled=!0,i.shadowMap.type=2,i.outputColorSpace=He,i.toneMapping=4,i.toneMappingExposure=1.08,e.appendChild(i.domElement);let a=new Ss(i);a.compileEquirectangularShader();let o=new zu;t.environment=a.fromScene(o,.04).texture,o.dispose(),new Hu().load(dd,e=>{let n=a.fromEquirectangular(e).texture;e.dispose(),t.environment&&t.environment!==n&&t.environment.dispose(),t.environment=n,t.environmentIntensity=.85},void 0,()=>{});let s=new Eu(r,i.domElement);s.enableDamping=!0,s.dampingFactor=.07,s.minDistance=6,s.maxDistance=60,s.maxPolarAngle=Math.PI*.495,s.target.set(0,4.5,0),t.add(new Mo(16777215,.22));let c=new jo(16774634,1.55);c.position.set(9,18,7),c.castShadow=!0,c.shadow.mapSize.set(2048,2048),c.shadow.camera.near=1,c.shadow.camera.far=60,c.shadow.camera.left=-22,c.shadow.camera.right=22,c.shadow.camera.top=22,c.shadow.camera.bottom=-22,c.shadow.bias=-15e-5,c.shadow.normalBias=.02,t.add(c);let l=new jo(14083327,.55);l.position.set(-12,9,-3),t.add(l);let u=new jo(16777215,.45);u.position.set(-2,12,-14),t.add(u);let d=new jo(16775408,.25);d.position.set(0,-4,6),t.add(d);let m=[],h=(e,n,r,i,a)=>{let o=new Kr({color:new J(1,1,1),transparent:!0,opacity:r,side:2,depthWrite:!1});m.push(o);let s=new X(new ba(e,n),o);s.position.copy(i),s.lookAt(a),s.renderOrder=-1,t.add(s)};h(14,10,.55,new G(12,14,8),new G(0,5,0)),h(10,8,.35,new G(-11,10,-6),new G(0,5,0)),h(16,6,.25,new G(0,16,-8),new G(0,5,0));let g=new X(new zi(36,64),new wa({opacity:.38}));g.rotation.x=-Math.PI/2,g.position.y=0,g.receiveShadow=!0,t.add(g);let _=new Ia({color:new J(n).multiplyScalar(.95),roughness:.55,metalness:.02,clearcoat:.15,clearcoatRoughness:.5,envMapIntensity:.35}),v=new X(new zi(32,64),_);v.rotation.x=-Math.PI/2,v.position.y=-.015,v.receiveShadow=!0,t.add(v),g.userData.floor=v;let y=()=>{let t=e.getBoundingClientRect(),n=Math.max(t.width,1),a=Math.max(t.height,1);r.aspect=n/a,r.updateProjectionMatrix(),i.setSize(n,a,!1)};y();let b=new ResizeObserver(y);b.observe(e),p.current={renderer:i,scene:t,camera:r,controls:s,productRoot:null,artTex:null,ground:g,pmrem:a,softboxMats:m,animId:0};let x=()=>{let e=p.current;e&&(e.animId=requestAnimationFrame(x),e.controls.update(),e.renderer.render(e.scene,e.camera))};return x(),()=>{b.disconnect();let t=p.current;if(t){cancelAnimationFrame(t.animId),t.productRoot&&(t.scene.remove(t.productRoot),pd(t.productRoot)),t.artTex&&t.artTex.dispose();for(let e of t.softboxMats)e.dispose();t.controls.dispose(),t.pmrem.dispose(),t.scene.environment?.dispose(),t.renderer.dispose(),t.renderer.domElement.parentNode===e&&e.removeChild(t.renderer.domElement)}p.current=null}},[]),(0,r.useEffect)(()=>{let e=p.current;if(!e)return;e.scene.background=new J(n);let t=e.ground.userData.floor;if(t){let e=t.material;e.color=new J(n).multiplyScalar(.95)}},[n]),(0,r.useEffect)(()=>{let n=p.current;if(!n)return;n.productRoot&&=(n.scene.remove(n.productRoot),pd(n.productRoot),null),n.artTex&&=(n.artTex.dispose(),null);let r=new On,u=ld(e,t,l);r.add(u),r.userData={...u.userData};let d=null;i&&(d=new Pi(fd(i,o)),d.colorSpace=He,d.anisotropy=n.renderer.capabilities.getMaxAnisotropy(),d.wrapS=s,d.wrapT=s,d.needsUpdate=!0,n.artTex=d);let f=md(u,d,a,o,c);r.add(f),n.scene.add(r),n.productRoot=r;let m=u.userData.targetY??Ju(e).heightCm/2;if(n.controls.target.set(0,m,0),r.userData.productId=e,n.lastProductId!==e){let t=hd(e);n.camera.position.set(t*.55,m+(e===`prato`?t*.42:t*.16),t*.72),n.lastProductId=e}n.controls.update()},[e,t,i,a,o,c,l]),(0,$.jsx)(`div`,{ref:f,className:u})}),_d=e(),vd=[{id:`quad1080`,label:`Quadrado 1080`,width:1080,height:1080},{id:`ml1200`,label:`ML 1200×1600`,width:1200,height:1600},{id:`alta2048`,label:`Alta 2048`,width:2048,height:2048}];function yd(e,t,n=`mockup-dtf`){if(!e)return!1;let r=e.capture(t.width,t.height);if(!r)return!1;let i=r.indexOf(`,`),a=r.slice(i+1),o=atob(a),s=new Uint8Array(o.length);for(let e=0;e<o.length;e++)s[e]=o.charCodeAt(e);let c=new Blob([s],{type:`image/png`});return(0,_d.saveAs)(c,`${n}-${t.width}x${t.height}.png`),!0}var bd={offsetXCm:0,offsetYCm:0,rotationDeg:0,flipH:!1,flipV:!1};function xd(e){return Uu.find(t=>t.size&&t.size.width===e.width&&t.size.height===e.height)?.id??`custom`}function Sd({onLogout:e}){let[t,n]=(0,r.useState)(`copo_americano`),[i,a]=(0,r.useState)(()=>Yu(`copo_americano`)),[o,s]=(0,r.useState)(.08),[c,l]=(0,r.useState)(`#e8eef5`),[u,d]=(0,r.useState)(null),[f,p]=(0,r.useState)(``),[m,h]=(0,r.useState)(()=>Ju(`copo_americano`).defaultArtSizeCm),[g,_]=(0,r.useState)(()=>xd(Ju(`copo_americano`).defaultArtSizeCm)),[v,y]=(0,r.useState)({...bd}),[b,x]=(0,r.useState)(!0),[S,C]=(0,r.useState)(vd[0].id),[w,T]=(0,r.useState)(``),[E,D]=(0,r.useState)(!1),O=(0,r.useRef)(null),k=(0,r.useRef)(null),A=Ju(t),j=(0,r.useCallback)(e=>{if(!e.type.includes(`png`)&&!e.name.toLowerCase().endsWith(`.png`)){T(`Envie um PNG transparente.`);return}let t=URL.createObjectURL(e),n=new Image;n.onload=()=>{d(n),p(e.name),y({...bd}),T(`Arte carregada: ${e.name}`)},n.onerror=()=>{URL.revokeObjectURL(t),T(`Falha ao carregar a imagem.`)},n.src=t},[]),ee=e=>{let t=e.target.files?.[0];t&&j(t),e.target.value=``},M=(0,r.useCallback)(e=>{let t=e.clipboardData?.items;if(t){for(let n of t)if(n.type.startsWith(`image/`)){let t=n.getAsFile();if(t){e.preventDefault(),j(t);return}}}},[j]),N=(0,r.useCallback)(e=>{e.preventDefault(),D(!1);let t=e.dataTransfer.files?.[0];t&&j(t)},[j]),te=e=>{let t=Ju(e);n(e),a(Yu(e)),h({...t.defaultArtSizeCm}),_(xd(t.defaultArtSizeCm)),y({...bd}),s(.08),T(``)},ne=e=>{_(e);let t=Uu.find(t=>t.id===e);t?.size&&h({...t.size})},re=e=>{h(t=>{let n={width:Math.max(.5,Math.min(25,e.width??t.width)),height:Math.max(.5,Math.min(25,e.height??t.height))};return _(xd(n)),n})},P=e=>{y(t=>({...t,...e}))},ie=(e,t)=>{a(n=>({...n,[e]:t}))},ae=e=>{a(t=>{let n={...t};for(let t of A.colorParts)n[t.id]=e;return n})},oe=()=>{y(e=>({...e,offsetXCm:0,offsetYCm:0,rotationDeg:0}))},se=()=>{d(null),p(``),y({...bd}),T(`Arte removida.`)},ce=()=>{let e=vd.find(e=>e.id===S),n=f?f.replace(/\.png$/i,``):`mockup-${t}`,r=yd(O.current,e,`mockup-${t}-${n}`);T(r?`PNG baixado (${e.label}).`:`Não foi possível exportar.`)},F=(0,r.useMemo)(()=>`Arte: ${m.width}×${m.height} cm no produto`,[m]),le=A.material===`glass`,ue=A.material===`porcelain`,de=A.material===`metal`;return(0,$.jsxs)(`div`,{className:`mockup-studio`,onPaste:M,children:[(0,$.jsxs)(`header`,{className:`header mockup-header`,children:[(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`h1`,{children:`Mockup DTF UV`}),(0,$.jsx)(`p`,{className:`subtitle`,children:`Pré-visualização profissional em produtos rígidos — arte em tamanho real (cm), como adesivo UV DTF (não wrap 360°).`})]}),e&&(0,$.jsx)(`button`,{type:`button`,className:`btn sm logout-btn`,onClick:e,title:`Encerrar sessão`,children:`Sair`})]}),(0,$.jsxs)(`div`,{className:`mockup-layout`,children:[(0,$.jsxs)(`aside`,{className:`mockup-sidebar`,children:[(0,$.jsxs)(`section`,{className:`card`,children:[(0,$.jsx)(`h2`,{children:`Produto`}),(0,$.jsx)(`div`,{className:`product-grid product-grid-6`,children:qu.map(e=>(0,$.jsxs)(`button`,{type:`button`,className:`product-card ${t===e.id?`active`:``}`,onClick:()=>te(e.id),children:[(0,$.jsx)(`span`,{className:`product-icon`,"aria-hidden":!0,children:e.icon}),(0,$.jsx)(`span`,{className:`product-name`,children:e.name})]},e.id))}),(0,$.jsxs)(`p`,{className:`hint`,children:[A.diameterCm>0&&(0,$.jsxs)($.Fragment,{children:[`Dimensão: `,(0,$.jsxs)(`strong`,{children:[`Ø `,A.diameterCm,` × H `,A.heightCm,` cm`]}),(0,$.jsx)(`br`,{})]}),A.description]})]}),(0,$.jsxs)(`section`,{className:`card`,children:[(0,$.jsx)(`h2`,{children:`Arte PNG`}),(0,$.jsx)(`div`,{className:`dropzone ${E?`dragover`:``}`,onDragOver:e=>{e.preventDefault(),D(!0)},onDragLeave:()=>D(!1),onDrop:N,onClick:()=>k.current?.click(),role:`button`,tabIndex:0,onKeyDown:e=>{(e.key===`Enter`||e.key===` `)&&k.current?.click()},children:u?(0,$.jsxs)(`div`,{className:`art-preview-wrap`,children:[(0,$.jsx)(`img`,{src:u.src,alt:f,className:`art-preview`}),(0,$.jsx)(`span`,{className:`art-name`,children:f||`arte.png`})]}):(0,$.jsxs)(`p`,{children:[`Clique, solte ou cole (Ctrl+V)`,(0,$.jsx)(`br`,{}),(0,$.jsx)(`span`,{className:`muted`,children:`PNG transparente`})]})}),(0,$.jsx)(`input`,{ref:k,type:`file`,accept:`image/png,.png`,hidden:!0,onChange:ee}),(0,$.jsxs)(`div`,{className:`row-actions`,children:[(0,$.jsx)(`button`,{type:`button`,className:`btn primary`,onClick:()=>k.current?.click(),children:`Enviar PNG`}),u&&(0,$.jsx)(`button`,{type:`button`,className:`btn danger`,onClick:se,children:`Remover`})]})]}),(0,$.jsxs)(`section`,{className:`card`,children:[(0,$.jsx)(`h2`,{children:`Tamanho da arte`}),(0,$.jsx)(`div`,{className:`size-preset-grid`,children:Uu.map(e=>(0,$.jsx)(`button`,{type:`button`,className:`size-chip ${g===e.id?`active`:``}`,onClick:()=>ne(e.id),children:e.label},e.id))}),(0,$.jsxs)(`div`,{className:`grid-2 custom-size-row`,children:[(0,$.jsxs)(`label`,{className:`field`,children:[(0,$.jsx)(`span`,{children:`Largura (cm)`}),(0,$.jsx)(`input`,{type:`number`,min:.5,max:25,step:.1,value:m.width,onChange:e=>re({width:Number(e.target.value)})})]}),(0,$.jsxs)(`label`,{className:`field`,children:[(0,$.jsx)(`span`,{children:`Altura (cm)`}),(0,$.jsx)(`input`,{type:`number`,min:.5,max:25,step:.1,value:m.height,onChange:e=>re({height:Number(e.target.value)})})]})]}),(0,$.jsx)(`p`,{className:`size-readout`,"aria-live":`polite`,children:F}),(0,$.jsxs)(`label`,{className:`field checkbox-field`,children:[(0,$.jsx)(`input`,{type:`checkbox`,checked:b,onChange:e=>x(e.target.checked)}),(0,$.jsx)(`span`,{children:`Guia de área de impressão`})]})]}),(0,$.jsxs)(`section`,{className:`card`,children:[(0,$.jsx)(`h2`,{children:`Cores`}),le&&(0,$.jsxs)($.Fragment,{children:[(0,$.jsx)(`div`,{className:`preset-row`,children:Gu.map(e=>(0,$.jsx)(`button`,{type:`button`,className:`color-swatch ${i.glass===e.hex?`active`:``}`,style:{background:e.hex},title:e.label,onClick:()=>ie(`glass`,e.hex)},e.id))}),(0,$.jsxs)(`label`,{className:`field`,children:[(0,$.jsx)(`span`,{children:`Tom do vidro`}),(0,$.jsx)(`input`,{type:`color`,value:i.glass??`#e8f4fc`,onChange:e=>ie(`glass`,e.target.value)})]}),(0,$.jsxs)(`label`,{className:`field`,children:[(0,$.jsxs)(`span`,{children:[`Fosco (`,Math.round(o*100),`%)`]}),(0,$.jsx)(`input`,{type:`range`,min:0,max:1,step:.01,value:o,onChange:e=>s(Number(e.target.value))})]})]}),ue&&(0,$.jsxs)($.Fragment,{children:[(0,$.jsx)(`div`,{className:`preset-row`,children:Wu.map(e=>(0,$.jsx)(`button`,{type:`button`,className:`color-swatch`,style:{background:e.hex},title:e.label,onClick:()=>ae(e.hex)},e.id))}),(0,$.jsx)(`div`,{className:`grid-2`,children:A.colorParts.map(e=>(0,$.jsxs)(`label`,{className:`field`,children:[(0,$.jsx)(`span`,{children:e.label}),(0,$.jsx)(`input`,{type:`color`,value:i[e.id]??e.default,onChange:t=>ie(e.id,t.target.value)})]},e.id))})]}),de&&(0,$.jsxs)($.Fragment,{children:[(0,$.jsx)(`div`,{className:`preset-row`,children:Ku.map(e=>(0,$.jsx)(`button`,{type:`button`,className:`color-swatch ${i.body===e.hex?`active`:``}`,style:{background:e.hex},title:e.label,onClick:()=>ie(`body`,e.hex)},e.id))}),(0,$.jsx)(`div`,{className:`grid-2`,children:A.colorParts.map(e=>(0,$.jsxs)(`label`,{className:`field`,children:[(0,$.jsx)(`span`,{children:e.label}),(0,$.jsx)(`input`,{type:`color`,value:i[e.id]??e.default,onChange:t=>ie(e.id,t.target.value)})]},e.id))})]}),(0,$.jsxs)(`label`,{className:`field`,style:{marginTop:`0.5rem`},children:[(0,$.jsx)(`span`,{children:`Cor do fundo`}),(0,$.jsx)(`input`,{type:`color`,value:c,onChange:e=>l(e.target.value)})]})]}),(0,$.jsxs)(`section`,{className:`card`,children:[(0,$.jsx)(`h2`,{children:`Posição da arte`}),(0,$.jsxs)(`label`,{className:`field`,children:[(0,$.jsxs)(`span`,{children:[`Offset X (`,v.offsetXCm.toFixed(1),` cm)`]}),(0,$.jsx)(`input`,{type:`range`,min:-6,max:6,step:.1,value:v.offsetXCm,onChange:e=>P({offsetXCm:Number(e.target.value)})})]}),(0,$.jsxs)(`label`,{className:`field`,children:[(0,$.jsxs)(`span`,{children:[`Offset Y (`,v.offsetYCm.toFixed(1),` cm)`]}),(0,$.jsx)(`input`,{type:`range`,min:-6,max:6,step:.1,value:v.offsetYCm,onChange:e=>P({offsetYCm:Number(e.target.value)})})]}),(0,$.jsxs)(`label`,{className:`field`,children:[(0,$.jsxs)(`span`,{children:[`Rotação (`,Math.round(v.rotationDeg),`°)`]}),(0,$.jsx)(`input`,{type:`range`,min:-180,max:180,step:1,value:v.rotationDeg,onChange:e=>P({rotationDeg:Number(e.target.value)})})]}),(0,$.jsxs)(`div`,{className:`row-actions wrap`,children:[(0,$.jsx)(`button`,{type:`button`,className:`btn`,onClick:oe,children:`Centralizar`}),(0,$.jsx)(`button`,{type:`button`,className:`btn ${v.flipH?`primary`:``}`,onClick:()=>P({flipH:!v.flipH}),children:`Espelhar H`}),(0,$.jsx)(`button`,{type:`button`,className:`btn ${v.flipV?`primary`:``}`,onClick:()=>P({flipV:!v.flipV}),children:`Espelhar V`})]})]}),(0,$.jsxs)(`section`,{className:`card`,children:[(0,$.jsx)(`h2`,{children:`Exportar`}),(0,$.jsxs)(`label`,{className:`field`,children:[(0,$.jsx)(`span`,{children:`Preset`}),(0,$.jsx)(`select`,{value:S,onChange:e=>C(e.target.value),children:vd.map(e=>(0,$.jsx)(`option`,{value:e.id,children:e.label},e.id))})]}),(0,$.jsx)(`button`,{type:`button`,className:`btn primary`,onClick:ce,disabled:!u,children:`Baixar PNG`}),(0,$.jsx)(`p`,{className:`hint`,children:`Sem marca d'água. O tamanho da arte no PNG é o mesmo da prévia 3D.`})]}),w&&(0,$.jsx)(`p`,{className:`status-line`,children:w})]}),(0,$.jsxs)(`section`,{className:`card mockup-preview-card`,children:[(0,$.jsxs)(`div`,{className:`preview-toolbar`,children:[(0,$.jsx)(`h2`,{children:`Pré-visualização`}),(0,$.jsxs)(`div`,{className:`row-actions`,children:[(0,$.jsx)(`button`,{type:`button`,className:`btn sm`,onClick:()=>O.current?.setViewAngle(`frente`),children:`Ângulo Frente`}),(0,$.jsx)(`button`,{type:`button`,className:`btn sm`,onClick:()=>O.current?.setViewAngle(`tresquartos`),children:`Ângulo ¾`})]})]}),(0,$.jsxs)(`p`,{className:`hint preview-hint`,children:[`Arraste para orbitar · scroll para zoom · `,F]}),(0,$.jsx)(gd,{ref:O,className:`mockup-canvas`,productId:t,colors:i,backgroundColor:c,artImage:u,artSizeCm:m,transform:v,showGuide:b,frosting:o})]})]})]})}export{Sd as default};